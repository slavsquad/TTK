...
public class JFontChooser extends JComponent
{
    ...
    protected JDialog createDialog(Component parent)
    {
        ...
        buttonsPanel.setBorder(BorderFactory.createEmptyBorder(0, 0, 3, 3));
        ...
        JPanel dialogEastPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        dialogEastPanel.add(buttonsPanel);

        dialog.getContentPane().add(this, BorderLayout.CENTER);
        dialog.getContentPane().add(dialogEastPanel, BorderLayout.SOUTH);
        dialog.pack();
    ...
    protected JTextField getSampleTextField()
    {
        if (sampleText == null)
        {
            ...
            sampleText = new JTextField(("AaBbYyZz АаБбЗзЯя"));
